...
function Submit({text}) {
  return (
    <button className="pt-sans-regular w-[85%] sm:w-[25.65rem] flex items-center justify-center mt-1 font-bold text-white text-xl mx-auto px-3 py-2 rounded-lg bg-gradient-to-t from-secondary to-primary">
      {text || "Submit"}
    </button>
  );
}
