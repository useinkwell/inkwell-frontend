...
function Search() {
  return (
    <div className="fixed z-30 top-0 bottom-0 left-0 right-0 bg-white h-screen flex flex-col justify-center">
      <div>
        ...
        <div className="">
          ...
          <div className="flex items-center pr-6">
            <div className="flex-grow text-center font-semibold">
              ...
              <div className="h-1 bg-[#E0E0E0] w-32 mx-auto mt-3"></div>
            </div>
          ...
          {/* Results */}
          <div className="flex flex-col gap-5 mt-8 max-w-6xl mx-auto">
