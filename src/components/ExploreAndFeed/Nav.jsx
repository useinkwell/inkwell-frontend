    ...
    return ( 
        ...
        <div className="flex items-start justify-between max-w-5xl mx-auto h-24">
          ...
          <div href="/" className="relative w-24 h-14">
            <Link href="/">
              <Image src="/images/inkwell.png" alt="nav bars" fill />
            </Link>
          </div>
          {/* right navigation */}
          <div className="relative pt-4 flex gap-5">
            ...
            <div className="relative h-5 w-8 hidden sm:flex">
              <Image src="/icons/folder-icon.svg" fill />
            </div>
            <div className="relative h-5 w-8 hidden sm:flex">
              <Image src="/icons/bell-icon.svg" fill />
            </div>
            <div className="relative h-5 w-8 hidden sm:flex">
              <Image src="/icons/back-icon.svg" fill />
            </div>
            <div className="relative h-5 w-8 hidden sm:flex">
              <Image src="/icons/profile-icon.svg" fill />
            </div>
          </div>
        </div>
        {/* bottom */}
